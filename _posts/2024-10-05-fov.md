...
$$
\theta_h = 2 * \arctan(\frac{W}{2f})
$$

垂直方向视场角：

$$
\theta_v = 2 * \arctan(\frac{H}{2f})
$$

对角线视场角:

$$
\theta_d = 2 * \arctan(\frac{D}{2f})
$$
...
$$
\theta_h = 2 * \arcsin(\frac{W}{4f})
$$

垂直方向视场角：

$$
\theta_v = 2 * \arcsin(\frac{H}{4f})
$$

对角线视场角:

$$
\theta_d = 2 * \arcsin(\frac{D}{4f})
$$
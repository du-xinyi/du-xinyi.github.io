...
categories: [Notepad]
tags: [ros, moveit]
img_path: 'posts/2023-09-15-moveit/'
---
...
![Alt text](moveit-setup-assistant.png)  
...
![Alt text](self-collision.png)  
![Alt text](collision-matrix.png)
...
![Alt text](planning-groups.png)  
- 输入`Group Name`为`arm`
- 选择`kdl_kinematics_plugin/KDLKinematicsPlugin`作为运动学求解器。使用自定义IK求解器，详见[Kinematics/IKFast](https://docs.ros.org/kinetic/api/moveit_tutorials/html/doc/ikfast/ikfast_tutorial.html)
- 保持其余选项不变
...
![Alt text](arm-planning-groups.png)  
手爪同理
...
![Alt text](arm-position-controller.png)  
手爪同理
